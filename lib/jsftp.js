...
var DBG_COLOR = "\x1b[30;1m";
var NRM_COLOR = "\x1b[39;49m";
...
(function() {
    ...
    this.parse = function(action) {
        ...
        if (this.debugmode) { console.log(DBG_COLOR+"command: "+command+"\nftpResponse: "
            +util.inspect(ftpResponse)+NRM_COLOR); }
